...
class Bot:
    def __init__(self, config_file=None):
        if config_file:
            ...
            self.upper_rsi = random.uniform(50, 95)
            self.lower_rsi = random.uniform(10, 50)
            self.period = random.randint(10, 50)
...
while round_num <= 100:  # Change the number of rounds as needed
